...
using ProxyPool.Repository.DataSeed;
using Microsoft.AspNetCore.Http;

namespace ProxyPool.Repository.Base
{
    /// <summary>
    /// SQL 操作上下文
    /// </summary>
    public class DB : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            MethodInfo configureEntity = typeof(DB).GetMethod(
            ...
            foreach (var entityType in builder.Model.GetEntityTypes())
            {
                ...
                {
                    Microsoft.EntityFrameworkCore.Metadata.Builders.PropertyBuilder idPropertyBuilder = entityTypeBuilder.Property(nameof(EntityBase<Guid>.Id));
                ...
                foreach (var mutableProperty in entityType.GetProperties())
                {
                    ...
                    {
                        entityTypeBuilder.Property(propertyName).HasColumnType("varchar");
                    }
                    if (mutableProperty.ClrType == typeof(Nullable<Guid>))
                    {
                        entityTypeBuilder.Property(propertyName).HasColumnType("varchar").IsRequired(false);
                    }
                }
